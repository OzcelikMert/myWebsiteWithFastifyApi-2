...
const ComponentPageBlogPrevBlog = React.memo((props: IComponentProps) => {
  ...
  return (
    <article className="prev-blog" title={props.item.contents?.title}>
      <div className="card">
...
export default ComponentPageBlogPrevBlog;
