...
const ComponentThemeFeatures: IComponentWithServerSideProps<IComponentProps> =
  React.memo((props) => {
              ...
              <div className="row">
                <div className="col-md-6">
                  <ComponentFeatureIcon
                    title={
                      componentElementContents('feature1Title')?.content ?? ''
                    }
                    describe={
                    ...
                    icon={
                      componentElementContents('feature1Icon')?.content ?? ''
                    }
                    color="blue"
                  />
                </div>
                <div className="col-md-6">
                  <ComponentFeatureIcon
                    title={
                      componentElementContents('feature2Title')?.content ?? ''
                    }
                    describe={
                    ...
                    icon={
                      componentElementContents('feature2Icon')?.content ?? ''
                    }
                    color="red"
                  />
                </div>
                <div className="col-md-6">
                  <ComponentFeatureIcon
                    title={
                      componentElementContents('feature3Title')?.content ?? ''
                    }
                    describe={
                    ...
                    icon={
                      componentElementContents('feature3Icon')?.content ?? ''
                    }
                    color="orange"
                  />
                </div>
                <div className="col-md-6">
                  <ComponentFeatureIcon
                    title={
                      componentElementContents('feature4Title')?.content ?? ''
                    }
                    describe={
                    ...
                    icon={
                      componentElementContents('feature4Icon')?.content ?? ''
                    }
                    color="green"
                  />
                </div>
...
export default ComponentThemeFeatures;
